...
/// Static [`Spec`](::connectrpc::Spec) for the server-side `GetDepositWithdrawConfig` RPC.
///
...
/// Monomorphic dispatcher for `ZipperService`.
///
...
///
/// let server = ZipperServiceServer::new(MyImpl);
...
///
/// ```rust,ignore
/// let resp = client.get_deposit_withdraw_config(request).await?;
...
///
/// ```rust,ignore
/// let owned = client.get_deposit_withdraw_config(request).await?.into_owned();
/// ```
///
    ...
    <T::ResponseBody as ::connectrpc::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the GetDepositWithdrawConfig RPC. Sends a request to /chain.zipper.v1.ZipperService/GetDepositWithdrawConfig.
    ...
    /// Call the GetDepositWithdrawConfig RPC with explicit per-call options. Options override [`ClientConfig`](::connectrpc::client::ClientConfig) defaults.
