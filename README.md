...
**Status:** Alpha (`0.1.0-alpha.47`, git tag `v0.1.0a47`). Proprietary license
...
```toml
[dependencies]
polyester-sdk = { git = "https://github.com/Fabric-Labs/polyester-sdk-rust", tag = "v0.1.0a47" }
```
