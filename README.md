...
**Status:** Alpha (`0.1.0-alpha.44`, git tag `v0.1.0a44`). Proprietary license
...
```toml
[dependencies]
polyester-sdk = { git = "https://github.com/Fabric-Labs/polyester-sdk-rust", tag = "v0.1.0a44" }
```
